          ...
          <div className="mx-auto max-w-2xl lg:max-w-4xl">
            <div className="flex flex-col items-center py-10">
              ...
              <p className="mt-2 text-base text-gray-500 italic">
                Your Trusted Solution for 24/7 Locksmith Services!
              </p>
            </div>
            ...
            <figure className="mt-10">
              ...
              <figcaption className="mt-10">
                <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                  <div className="text-gray-600">Give us a call!</div>
                </div>
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-3 text-base">
                  <a href="tel:+17472878400" className="text-blue-400 font-bold">
                      +1 (747) 287-8400
                  </a>
                </div>

                <div className="overflow-hidden text-center bg-white rounded shadow-2xl text-slate-500 shadow-slate-200">
                  <div className="relative p-6">
                    <figure className="relative z-10 flex flex-col items-center">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                        24/7 Locksmith Services is a locally owned company in Pasadena, California, with over a decade of experience. They offer fast and reliable locksmith services, backed by a satisfaction guarantee. Whether you need emergency help or routine assistance, their experienced team is dedicated to delivering top-notch service whenever you need it.
                        </p>
                      </blockquote>
                      <figcaption className="flex items-center gap-4 p-6 pt-2 text-sm text-left text-blue-500">
      
                        <div className="flex flex-col justify-center gap-1 mx-auto">
                          <span className="font-bold uppercase">- 24/7 Locksmith Services</span>
                        </div>
                      </figcaption>
                    </figure>
                    <svg
